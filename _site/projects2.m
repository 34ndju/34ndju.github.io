...
Internal tool for [Contrary Capital](https://contrarycap.com) to surf...">
    ...
    <link href="https://domain.com/projects2.m" rel="canonical">
    <link rel="alternate" type="application/rss+xml" title="Nathan Ju 🚂" href="https://domain.com/feed.xml">
    <!-- Global site tag (gtag.js) - Google Analytics -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-77388290-2"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'UA-77388290-2');
    </script>
  ...
  <header class="site-header">
    <div class="wrapper">
    	<a href="/"><img class="displayed" src="/images/big.png" alt=""></a>
    </div>
  </header>
...
Built a company in high school. Sales lead marketplace with 240,000 user-uploaded sales leads. This project got me interested in IR and startups.
    ...
    <nav class="site-nav">
        ...
        <!--
        <div class="trigger">
          <a class="page-link" href="https://twitter.com/nathanju34" target="_blank">
            <span class="icon  icon--twitter">
              <svg viewBox="0 0 16 16">
                <path fill="#000000" d="M15.969,3.058c-0.586,0.26-1.217,0.436-1.878,0.515c0.675-0.405,1.194-1.045,1.438-1.809
          ...
          <a class="page-link" href="https://github.com/34ndju" target="_blank">
